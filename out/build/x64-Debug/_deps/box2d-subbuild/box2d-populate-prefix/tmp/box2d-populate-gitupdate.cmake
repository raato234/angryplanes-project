...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v2.4.1"
  WORKING_DIRECTORY "C:/Users/rasmu/Työpöytä/visualcode files/test123/group-4-project-angry-planes/out/build/x64-Debug/_deps/box2d-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/rasmu/Työpöytä/visualcode files/test123/group-4-project-angry-planes/out/build/x64-Debug/_deps/box2d-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/rasmu/Työpöytä/visualcode files/test123/group-4-project-angry-planes/out/build/x64-Debug/_deps/box2d-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
